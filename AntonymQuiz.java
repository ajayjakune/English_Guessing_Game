...
public class AntonymQuiz {
	...
	public static void main(String[] args) {
        ...
        try {  
        	...
        	System.out.println("-----*-----Antonyms Quize-----*------");
        	System.out.println("--------> Guess Correct Antonym");
        	...
        	op[0] = rs.getString("antonym");
        	randomNum = rm.nextInt(7127) + 1;
        	rs = stmt.executeQuery("Select antonym from vocabulary where id="+randomNum+";");
        	op[1] = rs.getString("antonym");
        	randomNum = rm.nextInt(7127) + 1;
        	rs = stmt.executeQuery("Select antonym from vocabulary where id="+randomNum+";");
        	op[2] = rs.getString("antonym");
        	randomNum = rm.nextInt(7127) + 1;
        	rs = stmt.executeQuery("Select antonym from vocabulary where id="+randomNum+";");
        	op[3] = rs.getString("antonym");
