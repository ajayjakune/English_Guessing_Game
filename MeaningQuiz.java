...
public class MeaningQuiz {
	...
	public static void main(String[] args) {
        ...
        try {  
        	...
        	System.out.println("-----*-----Meaning Quize-----*------");
        	System.out.println("--------> Guess Correct Meaning");
        	...
        	op[0] = rs.getString("meaning");
        	randomNum = rm.nextInt(7127) + 1;
        	rs = stmt.executeQuery("Select meaning from vocabulary where id="+randomNum+";");
        	op[1] = rs.getString("meaning");
        	randomNum = rm.nextInt(7127) + 1;
        	rs = stmt.executeQuery("Select meaning from vocabulary where id="+randomNum+";");
        	op[2] = rs.getString("meaning");
        	randomNum = rm.nextInt(7127) + 1;
        	rs = stmt.executeQuery("Select meaning from vocabulary where id="+randomNum+";");
        	op[3] = rs.getString("meaning");
        	
        	choice = rm.nextInt(4) + 1;
        	switch(choice) {
        	
        	case 1: System.out.println(" 1."+op[0]+"\n 2."+op[1]+"\n 3."+op[2]+"\n 4."+op[3]);
        			break;
        	case 2: System.out.println(" 1."+op[1]+"\n 2."+op[0]+"\n 3."+op[2]+"\n 4."+op[3]);
					break;
        	case 3: System.out.println(" 1."+op[2]+"\n 2."+op[1]+"\n 3."+op[0]+"\n 4."+op[3]);
					break;
        	case 4: System.out.println(" 1."+op[3]+"\n 2."+op[1]+"\n 3."+op[2]+"\n 4."+op[0]);
					break;
